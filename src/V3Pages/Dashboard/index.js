...
class V3Dashboard extends Component {
            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="flex md:gap-10 mt-10">
                    <div className="w-2/5">
                        ...
                        <Card>
                            <>
                                <ProfileAvatarHalf invite={this.state.invite} loading={this.state.loading} user={this.state.user} badges={this.state.badges} currentUser={this.props.currentUser} className=" px-6 py-6 border-b-2 border-gray-200" fullName="Sethu Sathyan" points='20' />
                            </>
                        </Card>
                    </div>
