        ...
        <FeedLayout>
            <div className="flex" >
                ...
                <div className="flex-1 ml-4 text-sm">
                    <div className="font-bold"><Link className="hover:underline" to={`/u/${userInfo.username}`}>{userInfo.displayName ? userInfo.displayName : <span>{`@${userInfo.username}`}</span>}</Link> <span className="font-thin ml-1">merged a Pull Request 🔥</span></div> 
                    <div>
                        <div className="flex">
